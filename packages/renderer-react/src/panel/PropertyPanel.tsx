...
import { buildUpdatePropsCommand, type ContentKey, type GeometryKey } from "../write/buildUpdatePropsCommand.js";
import { geometryFieldState } from "./geometryFieldState.js";
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 8, padding: 8 }}>
      ...
      <NumberField
        ...
        badge={geometryFieldState(node, activeBreakpoint, "x")}
      ...
      <NumberField
        ...
        badge={geometryFieldState(node, activeBreakpoint, "y")}
      ...
      <NumberField
        ...
        badge={geometryFieldState(node, activeBreakpoint, "width")}
      ...
      <NumberField
        ...
        badge={geometryFieldState(node, activeBreakpoint, "height")}
